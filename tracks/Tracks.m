...
- (void)performQuery:(SDSearchQuery *)query withResultsPipe:(SDSearchQuery *)results {
	...
	[NSURLConnection sendAsynchronousRequest:request queue:operationQueue completionHandler:^(NSURLResponse *response, NSData *data, NSError *error){
		if (data != nil) {
			...
			TLCommitResults(searchResults, TLDomain(@"com.spotify.client", @"SpotifySearchTracks"), results);
		}
...
- (NSArray *)searchDomains {
	return [NSArray arrayWithObject:[NSNumber numberWithInteger:TLDomain(@"com.spotify.client", @"SpotifySearchTracks")]];
}
